...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                ...
                <div id="wrapper_home">
                    ...
                    <div class="glove-container">
                        <div class="glove-row glove-row-core">
                            ...
                            <xsl:apply-templates select="womenGloves/glove">
    ...
    <xsl:template match="glove">
        <div class="glove_item">
            ...
            <div class="gloveInfo">
                <h3>
                    <xsl:value-of select="gloveName" />
                </h3>
                <p>
                    <xsl:value-of select="description" />
                </p>
                <xsl:value-of select="gloveID" />
                <br/>
